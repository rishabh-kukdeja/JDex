...
export default function CreateJDPage() {
    ...
    const { setJobs, platforms } = useApp();
    ...
    const [form, setForm] = useState({
        ...
        workMode: "Remote" as JobDescription["workMode"],
        experience: "", salaryMin: "", salaryMax: "",
        currency: "INR", openings: "1", description: "",
    ...
    const handlePublish = (asDraft: boolean) => {
        ...
        setTimeout(() => {
            const newJob: JobDescription = {
                id: `j${Date.now()}`, title: form.title, department: form.department,
                location: form.location, type: form.type, workMode: form.workMode,
                experience: form.experience, salaryMin: Number(form.salaryMin),
                salaryMax: Number(form.salaryMax), currency: form.currency,
                description: form.description, requirements: form.requirements,
                skills: form.skills, openings: Number(form.openings),
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            {step === 3 && (
                <Card><CardHeader><CardTitle>Publish Settings</CardTitle></CardHeader><CardContent className="space-y-6">
